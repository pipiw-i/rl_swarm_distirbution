...
class Logs:
    def __init__(self, logger_name, log_file_name):
        ...
        if not os.path.exists('/home/pipiw/PycharmProjects/RL/RL_algorithm_package/rddpg/mul_target_test/rl_logs'):
            os.makedirs('/home/pipiw/PycharmProjects/RL/RL_algorithm_package/rddpg/mul_target_test/rl_logs')
